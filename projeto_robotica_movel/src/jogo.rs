...
impl Jogo {
    ...
    pub fn imprime_mapa(&mut self) {
        ...
        println!(
            "\nPitch: {}\t Roll: {}\n",
            self.carteiro.get_sensor_pitch(),
            self.carteiro.get_sensor_roll()
        );
    }
    ...
    pub fn update(&mut self) {
        ...
        if self.carteiro.get_sensor_pitch() > 1.0
            || self.carteiro.get_sensor_pitch() < -1.0
            || self.carteiro.get_sensor_roll() > 1.0
            || self.carteiro.get_sensor_roll() < -1.0
        {
        ...
        if self.carteiro.get_pos_x() == self.caixa.get_pos_x()
        ...
        match self.carteiro.get_status() {
            ...
            Status::jogando_com_caixa => {
                if self.carteiro.get_pos_x() == self.destino_x
                    && self.carteiro.get_pos_y() == self.destino_y
                {
